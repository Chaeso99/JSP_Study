...
public class MemberMgr 
{
	...
	public Vector<ZipcodeBean> searchZipcode(String area3)
	{
		...
		{
			con = pool.getConnection();
			sql = "select zipcode, area1, area2, area3 from tblZipcode"
					+ " where area3 like ?";
			pstmt = con.prepareStatement(sql);
			// ?-> '%강남대로%'
...
//				vlist.addElement(bean);
	...
	public boolean insertMember(MemberBean bean)
	{
		...
		try 
		{
			...
			String hobby[] = bean.getHobby(); //위 배열이 넘어옴
			char hb[] = {'0', '0', '0', '0', '0'};
	...
	public MemberBean getMember(String id)
	{
		...
		{
			con = pool.getConnection();
			sql = "select id, pwd, name, gender, birthday, email, zipcode, address, hobby, job "
